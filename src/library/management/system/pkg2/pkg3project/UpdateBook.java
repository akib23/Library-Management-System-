...
public void CloseOption(){
    this.setDefaultCloseOperation(UpdateBook.DO_NOTHING_ON_CLOSE);
   ...
   if(conferm==0){
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(440, 546));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sq1="Update Book set Name='"+s1+"',Edition='"+s2+"',Publisher='"+s3+"' ,price='"+s4+"', Pages='"+s5+"' where Book_ID='"+s6+"'       ";
        pst=conn.prepareStatement(sq1);
        pst.execute();
