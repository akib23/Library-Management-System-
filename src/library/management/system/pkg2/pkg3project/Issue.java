...
PreparedStatement pst;
    ...
    public void Delete(){
       String sq1="delete from Book where Book_ID=?";
       try{
    ...
    this.setDefaultCloseOperation(Issue.DO_NOTHING_ON_CLOSE);
   ...
   if(conferm==0){
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/system/pkg2/pkg3project/Icons/search.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/system/pkg2/pkg3project/Icons/hand.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/system/pkg2/pkg3project/Icons/back.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(880, 599));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String sq1="insert into Issue(Book_ID,Name,Edision,Publisher,Price,Pages,Student_ID,SName,Course,Semester,Year,DateOfIssue) values (?,?,?,?,?,?,?,?,?,?,?,?)";
        if(jTextField7.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(null,"Please fill all the information");
        }
        else if(jTextField1.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(null,"Please fill all the information");
        }
        else if(((JTextField)jDateChooser1.getDateEditor().getUiComponent()).getText().compareTo("")==0){
        JOptionPane.showMessageDialog(null,"Please fill all the information");
    }
        else{
        try{
