...
PreparedStatement pst;
  ...
  public void CloseOption(){
    this.setDefaultCloseOperation(UpdateStudent.DO_NOTHING_ON_CLOSE);
   ...
   if(conferm==0){
    ...
    private void initComponents() {
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/library/management/system/pkg2/pkg3project/Icons/add.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sq1="Update Student set Name='"+s1+"', Course='"+s2+"',Semester='"+s3+"' ,Year='"+s4+"' where Student_ID='"+s6+"'       ";
        pst=conn.prepareStatement(sq1);
        pst.execute();
