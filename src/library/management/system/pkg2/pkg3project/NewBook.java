...
public void CloseOption(){
    this.setDefaultCloseOperation(NewBook.DO_NOTHING_ON_CLOSE);
   ...
   if(conferm==0){
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Fill The Information");
        ...
        setSize(new java.awt.Dimension(431, 527));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            else if(jTextField4.getText().compareTo("")==0){
                    JOptionPane.showMessageDialog(null,"Please fill all the information");
                    }
